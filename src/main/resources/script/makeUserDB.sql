...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`finance`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`finance` (
  `id` INT(11) NOT NULL,
  `Budget` INT(11) NULL,
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`tactic`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`tactic` (
  `id` INT(11) NOT NULL,
  `Attack` INT(11) NULL,
  `Marking` INT(11) NULL,
  `Offside` INT(11) NULL,
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`formation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`formation` (
  `id` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_formacje_taktyki1`
    ...
    REFERENCES `slaskdbBatch`.`tactic` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`person`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`person` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`coach`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`coach` (
  `id` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_trenerzy_osoby1`
    ...
    REFERENCES `slaskdbBatch`.`person` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`tournament`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`tournament` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`city`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`city` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`stadium`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`stadium` (
  `id` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_stadiony_miasta1`
    ...
    REFERENCES `slaskdbBatch`.`city` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`training`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`training` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`club`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`club` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`position`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`position` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`player`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`player` (
  `id` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_pilkarze_pozycje1`
    ...
    REFERENCES `slaskdbBatch`.`position` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`contract`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`contract` (
  `id` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_Kontrakt_pilkarze`
    ...
    REFERENCES `slaskdbBatch`.`player` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Kontrakt_kluby1`
    FOREIGN KEY (`club_idClub`)
    REFERENCES `slaskdbBatch`.`club` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`referee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`referee` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`fixture`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`fixture` (
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`arrange`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`arrange` (
  `id` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_Mecz_sedziowie1`
    ...
    REFERENCES `slaskdbBatch`.`referee` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_mecz_terminarz1`
    FOREIGN KEY (`fixture_idFixture`)
    REFERENCES `slaskdbBatch`.`fixture` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`staff`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`staff` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `slaskdbBatch`.`club_has_arrange`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`club_has_arrange` (
  ...
  CONSTRAINT `fk_club_has_arrange_arrange1`
    ...
    REFERENCES `slaskdbBatch`.`arrange` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;