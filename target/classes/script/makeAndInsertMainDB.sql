...
-- -------------------------------------------------------
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`role`(
    `id` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `slaskdbBatch`.`user_data`(
	...
	PRIMARY KEY (`id`),
            ...
            CONSTRAINT `fk_user_data_role`
              ...
              REFERENCES `slaskdbBatch`.`role` (`id`)
              ON DELETE NO ACTION
              ON UPDATE NO ACTION)
          ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Data for table `slaskdbBatch`.`role`
-- -----------------------------------------------------
START TRANSACTION;
USE `slaskdbBatch`;
INSERT INTO `slaskdbBatch`.`role` (`id`, `role_name`) VALUES (1, 'ROLE_ADMIN');
INSERT INTO `slaskdbBatch`.`role` (`id`, `role_name`) VALUES (2, 'ROLE_USER');
INSERT INTO `slaskdbBatch`.`role` (`id`, `role_name`) VALUES (3, 'ROLE_CODER');
